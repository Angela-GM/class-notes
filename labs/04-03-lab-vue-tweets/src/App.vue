...
<template>
  <div class="app">
    <!-- importar el componente hijo y añadir las propiedades (props) con v-bind -->
    <!-- Itración 2 -->
    <!-- <Tweet
      :userName="tweets[0].user.name"
      :userHandle="tweets[0].user.handle"
      :userTimestamp="tweets[0].timestamp"
      :userMessage="tweets[0].message"
      :userImage="tweets[0].user.image"
    /> -->
    <!-- Iteracion 9 -->
    <Tweet
